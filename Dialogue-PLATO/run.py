...
def main():
    ...
    # Loading datasets
    if hparams.do_train:
        raw_train_file = os.path.join(hparams.data_dir, "train.txt")
        ...
        raw_valid_file = os.path.join(hparams.data_dir, "dev.txt")
    ...
    if hparams.do_infer or hparams.do_test:
        raw_test_file = os.path.join(hparams.data_dir, "test.txt")
