...
parser.add_argument("--corpus", type=str, default="DSTC7_AVSD")
parser.add_argument("--preprocess", type=str, default="preprocess")
...
parser.add_argument("--model", type=str, default="cvaetrs")
...
parser.add_argument("--emb_file", type=str,default="embeddings/%s/vectors.txt")
...
parser.add_argument("--num_var_layers", type=int, default=1)
...
emb_file = "embeddings/{}/vectors.txt".format(corpus) or "vectors/glove.6B.{}d.txt".format(str(emb_dim))
